...
System.out.println("Connection is created successfully:");
      ...
      String sql;
sql = "update item_details set item_name='"+item_name+"' ,reorder_level="+(int)reorder_level+", average_monthly_usage="+average_monthly_usage+",reorder_qty="+reorder_qty+",stock="+stock+" where item_id="+item_id;
