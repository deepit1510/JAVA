...
public class supplier_insert_item extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					supplier_insert_item frame = new supplier_insert_item(id);
	 ...
	 * Create the frame.
	 */
	public supplier_insert_item(int id) {
		id1 = id;
		Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
		...
		lblItemName.setBounds(76, 181, 127, 29);
		contentPane.add(lblItemName);

		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(366, 172, 194, 50);
		...
		lblItemDescription.setBounds(76, 265, 136, 22);
		contentPane.add(lblItemDescription);

		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(366, 253, 194, 50);
		...
		lblNumberOfUnits.setBounds(76, 348, 194, 22);
		...
		lblPerUnitPrice.setBounds(76, 430, 115, 22);
		...
		lblAnualConsumption.setBounds(76, 519, 177, 22);
				...
				//	sup_id = Integer.parseInt(sp_id);
					...
					try {
						...
						sql = "insert into item(sup_id, item_name, item_des, crt_stk, anual_cons, order_cost, prdct_unt, prdct_price, load_time, stck_mant, eoq, re_order_lvl, safty_stk, lt_siz, no_odr) values("
								+ id + ",'" + name + "','" + des + "'," + crt_stk + "," + anual_cons + ","
						...
						supplier_insert_item insert = new supplier_insert_item(id);
		...
		textField_3.setBounds(366, 340, 194, 42);
		contentPane.add(textField_3);

		textField_4 = new JTextField();
		textField_4.setColumns(10);
		textField_4.setBounds(366, 419, 194, 48);
		contentPane.add(textField_4);

		textField_5 = new JTextField();
		textField_5.setColumns(10);
		textField_5.setBounds(366, 511, 194, 42);
		...
		label_1_2.setBounds(267, 340, 23, 27);
		...
		label_1_3.setBounds(189, 419, 23, 27);
		...
		label_1_4.setBounds(247, 511, 23, 27);
