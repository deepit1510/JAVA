...
public class display_supplier extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					display_supplier frame = new display_supplier();
	...
	public display_supplier() {
		...
		btnMainMenu.setBounds(456, 940, 232, 47);
		...
		btnPreviousMenu.setBounds(1023, 940, 232, 47);
