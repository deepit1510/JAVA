				...
				if (count == 0) {
					try {
						...
						if (rowCount > 0) {
							...
							JOptionPane.showMessageDialog(null, "The item id does not exist..................");
						}
					} catch (MySQLIntegrityConstraintViolationException excep) {
						JOptionPane.showMessageDialog(null,
								"The supplier id does not exist in the parent table successfully..................");
