...
public class Student_teacher_search_view extends JFrame {
	...
	public static void student_search_view(String admiss_no) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_teacher_search_view frame = new Student_teacher_search_view(admiss_no);
	 ...
	 * Create the frame.
	 */
	public Student_teacher_search_view(String admiss_no) {
