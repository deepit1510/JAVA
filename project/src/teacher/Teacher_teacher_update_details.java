...
public class Teacher_teacher_update_details extends JFrame {
	 ...
	 */
	public static void teacher_teacher_update_details(String t_id) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Teacher_teacher_update_details frame = new Teacher_teacher_update_details(t_id);
	 ...
	 * Create the frame.
	 */
	public Teacher_teacher_update_details(String t_id) {
		...
		lblLabel4.setBounds(20, 127, 174, 14);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				teacher_teacher_update_details(t_id);
			}
		});
