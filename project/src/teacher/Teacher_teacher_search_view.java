...
public class Teacher_teacher_search_view extends JFrame {
	 ...
	 */
	public static void Teacher_teacher_search_view(String t_id) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_teacher_search_view frame = new Student_teacher_search_view(t_id);
	 ...
	 * Create the frame.
	 */
	public Teacher_teacher_search_view(String t_id) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String sql;
					sql = "SELECT * FROM teachers where t_id = " + t_id1;
		...
		btnMainMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Teacher_login frame2 = new Teacher_login();
		...
		btnBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Teacher_teacher_search.teacher_teacher_search();;
			}
		});
