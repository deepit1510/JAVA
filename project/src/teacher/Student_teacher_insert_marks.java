...
public class Student_teacher_insert_marks extends JFrame {
	 ...
	 */
	public static void student_teacher_insert_marks(int admiss_no) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_teacher_insert_marks frame = new Student_teacher_insert_marks(session, cls, admin_no, roll_no, name,
	 ...
	 * Create the frame.
	 */
	public Student_teacher_insert_marks(String session, String cls, String admin_no, String roll_no, String name,
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					sql = "insert into students values('" + session + "'," + cls1 + "," + admiss_no1 + ","
