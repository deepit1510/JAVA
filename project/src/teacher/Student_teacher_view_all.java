...
public class Student_teacher_view_all {
	...
	private JTextField sce1;
	static String admiss_no;

	/**
	 * Launch the application.
	 */
	public static void student_teacher_view_all() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_teacher_view_all window = new Student_teacher_view_all();
	 ...
	 */
	public Student_teacher_view_all() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblEnterTheRoll = new JLabel("SESSION YEAR ( YYYY - YYYY )");
		lblEnterTheRoll.setForeground(Color.WHITE);
		lblEnterTheRoll.setBounds(36, 80, 177, 14);
		...
		sess1.setBounds(269, 77, 115, 20);
		frame.getContentPane().add(sess1);
		sess1.setColumns(10);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!admiss_no.matches("[0-9]+")) {
					...
					try {
						...
						if (rs.absolute(1)) {
							Student_teacher_search_view search = new Student_teacher_search_view(admiss_no);
		...
		sce1 = new JTextField();
		sce1.setForeground(new Color(128, 0, 0));
		sce1.setColumns(10);
		sce1.setBackground(Color.LIGHT_GRAY);
		sce1.setBounds(269, 108, 115, 20);
		frame.getContentPane().add(sce1);

		JLabel lblSection = new JLabel("SECTION");
		lblSection.setForeground(Color.WHITE);
		lblSection.setBounds(36, 111, 177, 14);
