...
public class Student_teacher_update_details extends JFrame {
	 ...
	 */
	public static void student_teacher_update_details(String admin_no) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_teacher_update_details frame = new Student_teacher_update_details(admin_no);
	 ...
	 * Create the frame.
	 */
	public Student_teacher_update_details(String admiss_no) {
		...
		lblLabel1.setBounds(20, 65, 218, 14);
		...
		lblNewLabel_3.setBounds(20, 285, 80, 14);
		...
		next.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!(s1 > 2005 && s == s1 + 1)) {
					...
					Student_teacher_update_marks Student_teacher_update_marks = new Student_teacher_update_marks(session, cls,
							admiss_no, roll_no, name, dob, fname, address, phn, email, teacher_id, gender);
					Student_teacher_update_marks.setVisible(true);
