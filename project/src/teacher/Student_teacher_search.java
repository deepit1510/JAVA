...
public class Student_teacher_search {
	 ...
	 */
	public static void student_teacher_search() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_teacher_search window = new Student_teacher_search();
