...
public class Teacher_teacher_insert extends JFrame {
	 ...
	 */
	public static void teacher_teacher_insert() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Teacher_teacher_insert frame = new Teacher_teacher_insert();
	...
	public Teacher_teacher_insert() {
		...
		lblLabel4.setBounds(20, 127, 210, 14);
