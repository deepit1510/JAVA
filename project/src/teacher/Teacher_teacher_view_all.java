...
public class Teacher_teacher_view_all extends JFrame {
	 ...
	 */
	public static void teacher_teacher_view_all() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Teacher_teacher_view_all frame = new Teacher_teacher_view_all();
	 ...
	 * Create the frame.
	 */
	public Teacher_teacher_view_all() {
		...
		btnMainMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Teacher_teacher_menu frame2 = new Teacher_teacher_menu();
