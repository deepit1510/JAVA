...
public class Student_login_view_all {
	 ...
	 */
	public static void student_login_view_all() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_login_view_all window = new Student_login_view_all();
