...
public class Student_login_search {
	 ...
	 */
	public static void student_login_search() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_login_search window = new Student_login_search();
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!admiss_no.matches("[0-9]+")) {
					...
					try {
						...
						if (rs.absolute(1)) {
							Student_login_search_view search = new Student_login_search_view(admiss_no);
