...
public class Student_update_marks extends JFrame {
	 ...
	 */
	public static void student_update_marks() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_update_marks frame = new Student_update_marks(session, section, admin_no, roll_no, name,
	 ...
	 * Create the frame.
	 */
	public Student_update_marks(String session, String section, String admin_no, String roll_no, String name,
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					sql = "update students set session = '" + session + "', sec = '" + section + "', roll_no = "
		...
		back.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//Student_update_details frame2 = new Student_update_details();
