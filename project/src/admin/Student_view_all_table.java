...
public class Student_view_all_table extends JFrame {
	 ...
	 */
	public static void student_view_all_table() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Student_view_all_table frame = new Student_view_all_table();
