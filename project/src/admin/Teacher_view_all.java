...
public class Teacher_view_all extends JFrame {
	 ...
	 */
	public static void teacher_view_all() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Teacher_view_all frame = new Teacher_view_all();
	...
	public Teacher_view_all() {
		...
		btnMainMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Teacher_admin_menu frame2 = new Teacher_admin_menu();
		...
		JLabel lblStudentsRecord = new JLabel("---- Teacher's Records ----");
