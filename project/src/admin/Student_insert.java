		...
		next.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!(s == s1 + 1)) {
					...
					Student_insert_marks student_insert_marks = new Student_insert_marks(session, cls, admin_no,
							roll_no, name, dob, fname, address, phn, email, teacher_id, gender);
					student_insert_marks.setVisible(true);
				}
			}
		}
