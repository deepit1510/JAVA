        ...
        btnConfirm.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
        		...
        		String password="";
                    ...
                    myPst.close();
                    myConn.close();
                    JOptionPane.showMessageDialog(Dialog, "Congratulations! You have now successfully registeredï¼�", "",JOptionPane.INFORMATION_MESSAGE);
                } catch (Exception exc) {
                	JOptionPane.showMessageDialog(Dialog, "Please Fill Out This Form Completely And Accuratelyï¼�", "",JOptionPane.WARNING_MESSAGE);
                	exc.printStackTrace();
                }
			}
