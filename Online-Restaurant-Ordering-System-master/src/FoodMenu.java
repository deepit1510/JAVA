...
public class FoodMenu implements ItemListener {
	...
	private static JFrame FoodMenu;
	private static JDialog Dialog;
	private static JTextField txtEnterUsername;
	static double totalFood;
	static double foodSSP=0;
	static double foodMPTF=0;
	static double foodSSM=0;
	static double foodSS=0;
	static double foodPD=0;
	static double foodBBB=0;
	static double foodNM=0;
	static double foodSF=0;
	static double foodSBS=0;
	static double foodHS=0;
	static double foodBWB=0;
	static double foodKPC=0;
	static double foodJR=0;
	static double foodHSMBS=0;
	static double foodWN=0;
	static int QtySSP=0;
	static int QtyMPTF=0;
	static int QtySSM=0;
	static int QtySS=0;
	static int QtyPD=0;
	static int QtyBBB=0;
	...
	static int QtyKPC=0;
	static int QtyJR=0;
	static int QtyHSMBS=0;
	static int QtyWN=0;
	static String totalOrder;
	static String strSSP="";
	static String strMPTF="";
	static String strSSM="";
	static String strSS="";
	static String strPD="";
	static String strBBB="";
	static String strNM="";
	static String strSF="";
	static String strSBS="";
	static String strHS="";
	static String strBWB="";
	static String strKPC="";
	static String strJR="";
	static String strHSMBS="";
	static String strWN="";
	static int PreQtySSP = 1;
	static int PreQtyMPTF = 1;
	static int PreQtySSM = 1;
	static int PreQtySS = 1;
	static int PreQtyPD = 1;
	static int PreQtyBBB = 1;
	static int PreQtyNM = 1;
	static int PreQtySF = 1;
	static int PreQtySBS = 1;
	static int PreQtyHS = 1;
	static int PreQtyBWB = 1;
	static int PreQtyKPC = 1;
	static int PreQtyJR = 1;
	static int PreQtyHSMBS = 1;
	static int PreQtyWN = 1;
	
	 static String[] choics = { "win.wav" }; 
	...
	private void initialize() {
		...
		btnPayBalance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 try{
		                Connection myConn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Restaurant","root","");
	                    ...
	                    try{
		                    ...
		                    try{
				                Connection SpentConn = DriverManager.getConnection("jdbc:mysql://localhost:3306/Restaurant","root","");
